"""
Django settings for pharma_verify project.
...
SECRET_KEY = config('SECRET_KEY', default='j1n_xn2_v3@ep(ee_n=*db79@ipwgh(59o3%=-u^mqym4#@d$1')
...
ROOT_URLCONF = 'pharma_verify.urls'
...
WSGI_APPLICATION = 'pharma_verify.wsgi.application'
...
MONGODB_SETTINGS = {
    ...
    'db': config('MONGODB_DB', default='pharma_verify_logs'),
